...
<head>
    ...
    <title>FabriLink</title>
    <link rel="shortcut icon" href="../imagenes/fabrilink.png" type="image/x-icon">
...
<body>
    ...
    <div id="container">
        <img src="../imagenes/fabrilink.png" class="fabri">
        <h1>Bienvenidos a fabrilink </h1>
        <p>Administra tus empleados </p>


    </div>
    <section class="section">
        <div class="contenido">
            <h2>Fabrilin la mejor opcion para tu empresa</h2>
            <p> Bienvenido a FabriLink, la solución perfecta para la gestión de empleados en tu empresa. En FabriLink,
                creemos que la gestión de
                empleados no debería ser una tarea tediosa y complicada, sino que debería ser fácil, eficiente y
                efectiva. Es por eso que hemos creado una plataforma en línea para ayudarte a administrar a tus
                empleados de manera efectiva y sin esfuerzo.
                Nuestra plataforma en línea te permite realizar un seguimiento de la información de tus empleados,
                incluyendo sus horarios de
                trabajo, días de vacaciones y detalles personales, todo en un solo lugar. Con FabriLink, también podrás
                gestionar el proceso de contratación de nuevos empleados y realizar evaluaciones de desempeño, lo que te
                permitirá tomar decisiones informadas sobre el personal de tu empresa.
                Además, en FabriLink nos aseguramos de que tus empleados tengan acceso a la información que necesitan,
                como sus horarios de trabajo y sus detalles de pago, a través de nuestra plataforma en línea fácil de
                usar.
                Con FabriLink, la gestión de empleados será más eficiente y efectiva que nunca. Regístrate hoy mismo y
                descubre cómo podemos ayudarte a hacer crecer tu empresa. </p>
        </div>
...
<footer>
    <nav class="items">
        <img src="../imagenes/fabrilink.png" class="fabril">
        <a href="https://www.facebook.com/profile.php?id=100090499884491"><img src="../imagenes/1384021.png" ></a>
        <a href="https://t.com"><img src="../imagenes/twitter.png"></a>
        <a href="https://instagram.com"><img src="../imagenes/"></a>
        <h1>Contacto: Fabrilink@gmail.com</h1>
